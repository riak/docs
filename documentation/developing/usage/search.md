...
aliases:
  ...
  - /riak/kv/2.2.3/dev/using/search
---
...
>
> If you are connecting to Riak using one of Basho's official [client libraries](/riak/kv/2.2.3/developing/client-libraries), you can find more information about getting started with your client in the [Developing with Riak KV: Getting Started](/riak/kv/2.2.3/developing/getting-started) section.
...
[Security](/riak/kv/2.2.3/using/security/) is a new feature as of
...
indexing process. You can even create your own [custom extractors](/riak/kv/2.2.3/developing/usage/custom-extractors).
...
More on Riak Data Types can be found in [Riak Data Types and Search](/riak/kv/2.2.3/developing/usage/searching-data-types).
...
one of the default types. A full tutorial can be found in [Custom Search Extractors](/riak/kv/2.2.3/developing/usage/custom-extractors).
...
[MapReduce](/riak/kv/2.2.3/developing/usage/mapreduce/) jobs. This is a useful cross-section for
