...
aliases:
  ...
  - /riak/kv/2.2.3/dev/references/protocol-buffers/store-object
---

Stores an object under the specified location, as determined by the
intended [key](/riak/kv/2.2.3/learn/concepts/keys-and-objects), [bucket](/riak/kv/2.2.3/learn/concepts/buckets), and [bucket type](/riak/kv/2.2.3/developing/usage/bucket-types). A bucket must always be specified (via
...
[bucket type](/riak/kv/2.2.3/developing/usage/bucket-types) is assigned, Riak will assign
`default`, which means that the [default bucket configuration](/riak/kv/2.2.3/configuring/reference/#default-bucket-properties) will be used.
...
`content` | The new or updated contented of the object. Uses the same `RpbContent` message returned as part of an `RpbGetResp` message, documented in [PBC Fetch Object](/riak/kv/2.2.3/developing/api/protocol-buffers/fetch-object)
...
as well as the object's [causal context](/riak/kv/2.2.3/learn/concepts/causal-context), in the `vclock`
