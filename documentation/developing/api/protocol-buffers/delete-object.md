...
aliases:
  ...
  - /riak/kv/2.2.3/dev/references/protocol-buffers/delete-object
---

Delete an object in the specified [bucket type](/riak/kv/2.2.3/using/cluster-operations/bucket-types)/bucket/key location.
