...
aliases:
  ...
  - /riak/kv/2.2.3/dev/taste-of-riak/querying-erlang
---
...
A more comprehensive discussion can be found in [Key/Value Modeling](/riak/kv/2.2.3/developing/key-value-modeling).
