...
aliases:
  ...
  - /riak/kv/2.2.3/ops/mdc/comparison
---

This document is a systematic comparison of [Version 2](/riak/kv/2.2.3/using/reference/v2-multi-datacenter) and [Version 3](/riak/kv/2.2.3/using/reference/v3-multi-datacenter) of Riak Enterprise's Multi-Datacenter
...
* Version 3 is able to take advantage of [Active Anti-Entropy](/riak/kv/2.2.3/learn/concepts/active-anti-entropy/) \(AAE)
